  ...
  <body id="mainbody">
   ...
   <h3 class="margin"><bold>PERFORMANCE MANAGEMENT SYSTEM</bold></h3>
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$_SESSION["IDhr"] = test_input($_POST["IDhr"]);
		
		$_SESSION["Passwordhr"] = test_input($_POST["Passwordhr"]);
		//$_SESSION["Password"] = sha1($_SESSION["Password"]);
		
		$q1=$_SESSION["IDhr"];
		$q2=$_SESSION["Passwordhr"];
		...
		$sql = mysqli_query($db,"SELECT * FROM hr WHERE IDhr ='$q1' AND Passwordhr = '$q2'");
